...
process {
    ...
    $CUPath = ($Filepath.tostring().replace('\setup.exe',''))+'\Updates_SP_CU'
    $command = "& '${FilePath}' /ACTION=Upgrade /Q /INSTANCENAME=${InstanceName} /INDICATEPROGRESS /UpdateEnabled=True /UpdateSource='${CUPath}'"
